...
def _rebuild_relationships() -> None:
    ...
    if not _is_sqlite:
        ...
        op.execute("ALTER TABLE relationships DROP CONSTRAINT IF EXISTS ck_relationships_no_self_reference")  # noqa: E501
        op.execute("ALTER TABLE relationships DROP CONSTRAINT IF EXISTS ck_relationships_known_type")  # noqa: E501
    _id_col = "INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT" if _is_sqlite else "INTEGER GENERATED BY DEFAULT AS IDENTITY NOT NULL PRIMARY KEY"  # noqa: E501
    op.execute(
        f"""
