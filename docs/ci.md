...
assets, runs the relationship-integrity diagnostic, and exercises all sixteen
tools through eighteen read/write and grant-management calls to the installed
