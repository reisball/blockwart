...
EXPECTED_OPERATIONS = {
    ...
    "/api/v1/admin/principals/{principal_id}/project-creator": {"post"},
    ...
    "/api/v1/objects/{service_id}/credential-references": {"post"},
    "/api/v1/objects/{object_id}/update-preview": {"post"},
    "/api/v1/objects/{object_id}/rename": {"post"},
    "/api/v1/objects/{object_id}/rename-preview": {"post"},
    ...
    "/api/v1/objects/{object_id}/access/adoption": {"post"},
