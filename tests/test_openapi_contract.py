...
EXPECTED_OPERATIONS = {
    ...
    "/api/v1/me/access-requests": {"get"},
    "/api/v1/mcp-contract": {"get"},
    "/api/objects": {"get"},
    "/api/objects/{object_id}": {"get"},
    "/api/v1/auth/me": {"get"},
    "/api/v1/access-requests": {"get"},
    "/api/v1/access-requests/{request_id}/cancellation": {"post"},
    "/api/v1/access-requests/{request_id}/decision": {"post"},
    ...
    "/api/v1/objects/{object_id}/access-requests": {"post"},
